...
<body>
    ...
    <div style="text-align: center; margin-top: 20px;">
        ...
        <a href="{{ route('controlVehicular.ticket.salida') }}"
            style="padding: 10px 15px; background-color: #f0f0f0; text-decoration: none; color: black; border: 1px solid #ccc; border-radius: 3px;">Volver</a>
    </div>
        ...
        async function imprimirTicket() {
            ...
            try {
                ...
                if (data.exito) {
                    ...
                    statusDiv.textContent = '❌ Error desde el servidor de impresión: ' + (data.error ||
                        'Error desconocido');
                ...
                statusDiv.className = 'error';
                alert(
                    'Error de conexión: No se pudo contactar a la impresora. Verifique que la PC (Estación de Impresión) esté encendida y el servidor de Node.js esté activo.');
            }
        }
